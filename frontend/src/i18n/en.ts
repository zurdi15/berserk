export const en = {
  ...
  errors: {
    ...
    image_search_unavailable: 'Image search is unavailable right now',
    image_url_not_allowed: 'That image URL is not allowed',
    ...
    // v0.36.0 Web Push
    push_disabled: 'Push alerts are not available on this server.',
    client_id_taken: 'That alert belongs to another user.',
    client_id_too_long: 'Alert identifier too long.',
  ...
  profile: {
    ...
    push: {
      ...
      hint: 'Rest and cardio end alerts even with the app closed.',
      enable: 'Enable alerts',
      disable: 'Disable alerts',
      test: 'Test',
      testSent: 'Alert sent to {count} device(s)',
      testNone: 'No subscribed devices',
      on: 'Alerts enabled on this device',
      needsInstall: 'On iPhone: Share → Add to Home Screen, then open berserk from there.',
      denied: 'Notifications are blocked for berserk in the system settings.',
      failed: 'Could not enable alerts.',
    },
    wear: {
  ...
  admin: {
    ...
    newPassword: 'New password',
    newPasswordOptional: 'New password (empty = keep current)',
  ...
  library: {
    ...
    imageSearchQuery: 'Exercise name (English)',
    imageSearchRun: 'Search',
    imageSearchHint: 'Images from free-exercise-db (public domain) — picked images are downloaded to your instance.',
  ...
  today: {
    ...
    bodyMapFront: 'Front',
    bodyMapBack: 'Back',
    bodyMapSets: 'no sets | {n} set | {n} sets',
  ...
  progress: {
    ...
    detail: {
      sessions: 'Sessions',
      sessionCount: 'no sessions | {n} session | {n} sessions',
      open: 'View detail',
    },
