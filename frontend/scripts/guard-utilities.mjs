...
// (pasó 3 veces en este proyecto). Este guard extrae toda utilidad de color
// usada en src/ y confirma que de verdad generó CSS en el build — grepear
// dist/assets es la única fuente de verdad porque ahí está lo que Tailwind
// realmente reconoció.
