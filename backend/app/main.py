...
from .routers import admin, auth, backup, body, calendar as calendar_router, exercises, media, progress as progress_router, rotation, routines, sharing, social, users, workouts
